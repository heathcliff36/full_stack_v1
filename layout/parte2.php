...
<footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2025 JMDEVELOPERS</a>.</strong> Todos los derechos reservados.
</footer>
</div>
<!-- ./wrapper -->
...
<!-- Bootstrap 4 -->
<script
    src="<?php echo $URL; ?>/public/templates/AdminLTE-3.2.0/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- AdminLTE App -->
<script src="<?php echo $URL; ?>/public/templates/AdminLTE-3.2.0/dist/js/adminlte.min.js"></script>

<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo $URL; ?>/public/templates/AdminLTE-3.2.0/dist/js/pages/dashboard3.js"></script>
