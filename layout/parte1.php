    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo $URL . "/usuarios/user_perfil/" . $perfil; ?>"
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-footer">
                            ...
                            <a href="<?php echo $URL; ?>/app/controllers/login/cerrar_sesion.php"
                                class="btn btn-default btn-flat float-right">Cerrar sesion <i
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?php echo $URL; ?>" class="brand-link">
                <img src="<?php echo $URL; ?>/public/images/flogob.png" alt="AdminLTE Logo"
